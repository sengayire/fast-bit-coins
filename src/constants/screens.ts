...
export const EMAIL_SCREEN_TITLE = 'email.header'

export const NEW_ACCOUNT_SCREEN_NAME = 'New_Account_Screen'
export const NEW_ACCOUNT_SCREEN_TITLE = 'account.header'

export const PASSWORD_SCREEN_NAME = 'Password_Screen'
export const PASSWORD_SCREEN_TITLE = 'password.header'
